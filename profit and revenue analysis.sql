...
order by  revenue_by_name  desc
 ...
 -- which type of pizza( catagory ) has highest revenue

select  pizza_category, 
sum(total_price) as revenue_by_catagory from pizza_sales 
group by pizza_category
order by  revenue_by_catagory  desc 
limit 1;

-- which type of pizza( size ) has highest revenue
